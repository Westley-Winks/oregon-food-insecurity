...
```{r employment status, message=FALSE}
clean_df %>% 
...
```{r hours per week, warning=FALSE}
clean_df %>% 
...
1. Seek out single mothers
Single mothers in Oregon have much higher food insecurity rates than the rest of the population. Reach out to local support groups and put up flyers letting them know where to find food.  
2. Partner with schools
Large households (5 or more) have higher food insecurity rates. These larger households are likely to have children in school. Partner with these local schools to raise awareness that there is help in the area.  
